...
object WikipediaRanking {
  ...
  def occurrencesOfLang(lang: String, rdd: RDD[WikipediaArticle]): Int = {
    ...
    rdd.aggregate(0)((count, art) => if (articleContainsLang(lang, art)) count + 1 else count
      , (_ + _))
  }

  def articleContainsLang(lang: String, art: WikipediaArticle): Boolean = {
    art.text.split(" ").contains(lang)
  }
